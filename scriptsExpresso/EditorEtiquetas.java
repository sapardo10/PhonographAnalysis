...
public class EditorEtiquetas {
    ...
    public void editorEtiquetas() {
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(android.R.id.title), withText("Editor de etiquetas"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.title2),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("Nada"), closeSoftKeyboard());

        ViewInteraction floatingActionButton = onView(
                allOf(withId(R.id.play_pause_fab),
                        childAtPosition(
                                childAtPosition(
